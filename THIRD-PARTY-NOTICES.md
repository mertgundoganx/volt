...
volt bundles the two typefaces below into the application. Both are licensed
under the SIL Open Font License 1.1, which requires the copyright notice and
the licence to travel with the software — so they are reproduced here in full.

The rest of volt is MIT licensed; see LICENSE.
